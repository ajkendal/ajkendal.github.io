export const csCertSpecializations = [
  {
  ...
  },
  {
    ...
    issued: 'Apr 2025',
    id: 'U82W9O43ICKK',
    link: 'https://www.coursera.org/account/accomplishments/professional-cert/U82W9O43ICKK',
    courses: [
      {
  ...
  },
  {
    ...
    courses: [
      ...
      {
        title: 'Helpful JavaScript Code Snippets',
      },
      {
        title: 'Questions Answer Code Snipper Useful JavaScript Code',
      },
      {
        title: 'Reaction Game Setup',
      },
      {
        title: 'JavaScript InAction',
      },
      {
        title: "What's new ECMAScript 6",
      },
      {
        title: 'JSON and AJAX JavaScript',
      },
      {
      ...
      {
        title: 'JavaScript Dynamic Web with the DOM',
      },
      {
        title: 'Interactive Content JavaScript DOM and More',
      },
      {
      ...
      {
        title: 'JavaScript Logic Statements',
      },
      {
        title: 'Document Object Model Basics',
      },
      {
        title: 'JavaScript Multiple Values',
      },
      {
...
export const uxCertSpecializations = [
  {
    title: 'Google UX Design Specialization',
    issuer: 'Google',
    issued: 'Sep 2024',
    id: '44N444UAAEV2',
    link: 'https://www.coursera.org/account/accomplishments/professional-cert/44N444UAAEV2',
    courses: [
      {
